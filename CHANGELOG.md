...
- use Self for typehints in python bindings ([#71](https://github.com/nominal-io/nominal-streaming/pull/71))
...
- release v0.5.7 ([#70](https://github.com/nominal-io/nominal-streaming/pull/70))
