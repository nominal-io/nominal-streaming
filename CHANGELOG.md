...
## [0.10.1](https://github.com/nominal-io/nominal-streaming/compare/v0.10.0...v0.10.1) - 2026-09-18
...
- add opt-in runtime metric writing ([#340](https://github.com/nominal-io/nominal-streaming/pull/340))

### Other

- mark opts structs and error enums non_exhaustive ([#350](https://github.com/nominal-io/nominal-streaming/pull/350))
- fix clippy and nightly warnings, build CI on stable ([#349](https://github.com/nominal-io/nominal-streaming/pull/349))

## [0.9.10](https://github.com/nominal-io/nominal-streaming/compare/v0.9.9...v0.9.10) - 2026-09-16
...
- add simulated network consumer ([#280](https://github.com/nominal-io/nominal-streaming/pull/280))

## [0.9.1](https://github.com/nominal-io/nominal-streaming/compare/v0.9.0...v0.9.1) - 2026-05-16

### Other

- add feature-flagged instrumentation for work done on background threads ([#253](https://github.com/nominal-io/nominal-streaming/pull/253))

## [0.9.0](https://github.com/nominal-io/nominal-streaming/compare/v0.8.2...v0.9.0) - 2026-04-29

### Added

- write dataset rid into avro file user metadata ([#238](https://github.com/nominal-io/nominal-streaming/pull/238))

### Fixed

- truncate-on-open + flush-on-drop for AvroFileConsumer ([#235](https://github.com/nominal-io/nominal-streaming/pull/235))
