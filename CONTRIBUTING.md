...
- `just rust::check-dependencies`: Check the workspace for unused Rust dependencies with cargo-machete 0.9.1. `just install` installs it; the Nix dev shell includes it; CI installs it in the Rust lint job.
