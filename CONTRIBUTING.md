...
- `just rust::check-dependencies`: Check the workspace for unused Rust dependencies with cargo-machete. `just install` installs the pinned version; CI installs it in the Rust lint job.
