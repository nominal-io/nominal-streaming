...
class PyNominalLogStreamOpts:
    """Log stream options with read-only properties and fluent configuration methods."""

    def __init__(
        self,
        *,
        max_request_bytes: int = 8388608,
        max_batch_bytes: int = 16777216,
        ...
        max_backoff_secs: float = 5.0,
        max_retry_after_secs: float = 30.0,
    ) -> None: ...
    @property
    def max_request_bytes(self) -> int: ...
    def with_max_request_bytes(self, value: int) -> Self: ...
    @property
    def max_batch_bytes(self) -> int: ...
    def with_max_batch_bytes(self, value: int) -> Self: ...
    @property
    def max_buffered_bytes(self) -> int: ...
    def with_max_buffered_bytes(self, value: int) -> Self: ...
    @property
    def max_records_per_batch(self) -> int: ...
    def with_max_records_per_batch(self, value: int) -> Self: ...
    @property
    def max_request_delay_secs(self) -> float: ...
    def with_max_request_delay_secs(self, value: float) -> Self: ...
    @property
    def num_upload_workers(self) -> int: ...
    def with_num_upload_workers(self, value: int) -> Self: ...
    @property
    def base_api_url(self) -> str: ...
    def with_api_base_url(self, value: str) -> Self: ...
    @property
    def request_timeout_secs(self) -> float: ...
    def with_request_timeout_secs(self, value: float) -> Self: ...
    @property
    def max_retries(self) -> int: ...
    def with_max_retries(self, value: int) -> Self: ...
    @property
    def initial_backoff_secs(self) -> float: ...
    def with_initial_backoff_secs(self, value: float) -> Self: ...
    @property
    def max_backoff_secs(self) -> float: ...
    def with_max_backoff_secs(self, value: float) -> Self: ...
    @property
    def max_retry_after_secs(self) -> float: ...
    def with_max_retry_after_secs(self, value: float) -> Self: ...
    @property
    def num_runtime_workers(self) -> int: ...
    def with_num_runtime_workers(self, value: int) -> Self: ...
    def __repr__(self) -> str: ...
    def __str__(self) -> str: ...
...
class LogStreamStats:
    ...
    @property
    def backed_up_records(self) -> int: ...
    @property
...
class PyNominalLogStream:
    def __init__(self, opts: PyNominalLogStreamOpts | None = None) -> None: ...
    def with_core_consumer(self, dataset_rid: str, token: str | None = None) -> Self: ...
    def to_file(self, directory: pathlib.Path) -> Self: ...
    def with_file_fallback(self, directory: pathlib.Path) -> Self: ...
    def enable_logging(self, log_level: str | None = None) -> Self: ...
    def with_options(self, opts: PyNominalLogStreamOpts) -> Self: ...
    def open(self) -> None: ...
    def close(self, wait: bool = True) -> LogStreamStats | None: ...
    def stop_accepting_writes(self) -> None: ...
    def save_failed(self, directory: pathlib.Path) -> LogStreamStats: ...
    def stats(self) -> LogStreamStats: ...
    def flush(self) -> LogStreamStats: ...
    def enqueue(self, channel: str, timestamp: int, message: str, args: dict[str, str] | None = None) -> None: ...
    def enqueue_batch(
        self,
        channel: str,
        timestamps: Sequence[int],
        ...
        per_record_args: Sequence[dict[str, str]] | None = None,
    ) -> None: ...
