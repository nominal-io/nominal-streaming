...
class PyNominalLogStream:
    ...
    def with_core_consumer(self, dataset_rid: str, token: str | None = None) -> None: ...
    def to_file(self, directory: pathlib.Path) -> None: ...
    def with_file_fallback(self, directory: pathlib.Path) -> None: ...
    def open(self) -> None: ...
